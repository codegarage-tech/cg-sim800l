...
void setup()
{
  ...
  updateSerial();
  mySerial.println("AT+CBC"); //It will return the lipo battery state. The second number isthe % full (in this case its 93%) and the third number is the actual voltage in mV
  updateSerial();
}
